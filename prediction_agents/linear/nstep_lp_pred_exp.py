...
class nStepLpPredExp(VanillaLinearPrediction):
    def __init__(
            self,
            **kwargs
    ):
        super(nStepLpPredExp, self).__init__(**kwargs)
        ...
        self._step_schedule = optimizers.inverse_time_decay(self._lr_model,
                                                            ...
                                                            * 47,
                                                            100.0)
        # self._step_schedule = optimizers.exponential_decay(self._lr_model,
        #                                                    self._exploration_decay_period
        #                                                     * 17,
        #                                                     1e-2)
        # self._step_schedule = self._lr_model
    ...
    def model_update(
        ...
        if len(self._sequence) >= self._n:
            ...
            # print("alpha = {}".format(self._step_schedule(self.total_steps)))
            # print("alpha = {}".format(self._step_schedule))
