...
class LpIntrinsicVanilla(Agent):
    def __init__(
        ...
        def v_loss(v_params, h_params, transitions):
            ...
            h_tm1 = lax.stop_gradient(self._h_network.apply(h_params, o_tm1)) if self._latent else o_tm1
            v_tm1 = self._v_network.apply(v_params, h_tm1)
            v_t = self._v_network.apply(v_params, h_t)
        ...
        self._v_forward = jax.jit(self._v_network.apply)
        self._h_forward = jax.jit(self._h_network.apply)
