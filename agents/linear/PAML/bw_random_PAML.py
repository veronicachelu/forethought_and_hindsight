...
class LpBwRandomPAML(LpVanillaPAML):
    def __init__(
            self,
            **kwargs
    ):
        super(LpBwRandomPAML, self).__init__(**kwargs)
        ...
        model_params = [self._h_parameters, self._r_parameters]
    ...
    def model_update(
        ...
        if len(self._sequence) >= self._n:
            ...
            self._h_parameters, self._r_parameters = self._model_parameters
