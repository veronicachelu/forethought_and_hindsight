...
flags.DEFINE_integer('replay_capacity', 50, 'Planning depth for MCTS')
...
def main(argv):
    ...
    env_folder = os.path.join(best_hyperparam_folder, FLAGS.env)
    logs = os.path.join(env_folder, FLAGS.agent)
