...
flags.DEFINE_integer('max_len', 1000, 'Maximum number of time steps an episode may last (default: 100).')
...
flags.DEFINE_float('lr_ctrl', 0.05, 'learning rate for q optimizer')
