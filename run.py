...
flags.DEFINE_string('env', 'linear_tiny_maze', 'env')
...
flags.DEFINE_float('lr_p', 0.003, 'learning rate for q optimizer')
flags.DEFINE_float('lr_m',  0.004, 'learning rate for model optimizer')
